const String keyFieldId = 'objectId';

const String keyUserId = keyFieldId;
...
const String keyUserQuizzesScore = 'quizzesScore';
const String keyUserQtdUniqueCompletedQuizzes = 'qtdUniqueCompletedQuizzes';
...
const String keyCategoryTitle = 'title';

const String keyCourseTable = 'Course';
const String keyCourseId = keyFieldId;
const String keyCourseTitle = 'title';
const String keyCourseDescription = 'description';
