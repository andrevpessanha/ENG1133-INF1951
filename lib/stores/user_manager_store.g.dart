...
mixin _$UserManagerStore on _UserManagerStore, Store {
  ...
  final _$readyToFetchQuizzesAtom =
      Atom(name: '_UserManagerStore.readyToFetchQuizzes');

  @override
  bool get readyToFetchQuizzes {
    _$readyToFetchQuizzesAtom.reportRead();
    return super.readyToFetchQuizzes;
  }

  @override
  set readyToFetchQuizzes(bool value) {
    _$readyToFetchQuizzesAtom.reportWrite(value, super.readyToFetchQuizzes, () {
      super.readyToFetchQuizzes = value;
    });
  }
  ...
  dynamic setReadyToFetchQuizzes(bool value) {
    ...
    try {
      return super.setReadyToFetchQuizzes(value);
    } finally {
  ...
  String toString() {
    return '''
user: ${user},
readyToFetchQuizzes: ${readyToFetchQuizzes},
