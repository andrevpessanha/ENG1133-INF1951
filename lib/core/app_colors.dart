...
class AppColors {
  static final Color purple = Color(0xFF784CFB);
  static final Color lightPurple = Color(0xFF755BFF);
  static final Color yellow = Color(0xFFFBFB47);
  static final Color green = Color(0xFF29FF5B);
  ...
  static final Color orange = Color(0xFFFF621F);
